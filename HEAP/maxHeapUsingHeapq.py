...
heapq.heappush(maxHeap, -1 * 14)
heapq.heappush(maxHeap, -1 * 8)
heapq.heappush(maxHeap, -1 * 7)


# Check all elements in the Max Heap, the result is [-3, -1, -2]
print("maxHeap: ", maxHeap)
listss = [19, 37, 71, 71, 47, 5, 37, 73, 17, 5, 23]
list1 = [4,1,3,2,16,9,10,14,8,7]
list1.sort()
heapq.heapify(list1)
print(list1)
#heapq._heapify_min(listss)
heapq._heapify_max(listss)
print('max heap for quix',listss)
#print(maxheap)
